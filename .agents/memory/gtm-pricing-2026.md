...
description: Founding vs list pricing for staffing firms; validated against Bullhorn + ChatGPT stack costs.
---

# GTM pricing · June 2026
...
- 6h/week × $60/hr burdened = **~$1,560/seat/mo** lost productivity
- 10-seat desk = **~$15,600/mo** vs AskToAct list **$789/mo** (~20×) or founding **$399/mo** (~40×)

## Recommendation

### Keep as **list pricing** (public / Stripe)
- **$499** platform + **$29** per active seat
- **$299** per additional connector (when shipped)
- **$3,500** white-glove setup (optional; self-serve free)
