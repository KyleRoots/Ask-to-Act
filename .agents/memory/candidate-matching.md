...
- **Relevant-role recency is a boost, never a filter.** Current occupation or dated work-history titles that match the job’s required skills rank above the same skills sitting only on an old skill list. Last ~3 years is a strong bump, ~3–7 years a smaller one. Missing work-history dates are neutral (occupation may stand in). A current unrelated title (career change) is not rescued by a stale occupation. Do not present older relevant people as unqualified.
