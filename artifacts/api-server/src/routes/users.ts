  ...
  const toolSteps: Record<string, { label: string; tagline: string; steps: string[] }> = {
    chatgpt: {
      ...
      steps: [
        ...
        "Select <strong>Apps</strong> from the left menu",
        "Scroll to the bottom of the page and click <strong>Create app</strong> (under Advanced settings)",
        ...
        "<strong>Important — enable write access:</strong> Back on the Apps page, click on <strong>AskToAct</strong> (or your chosen name). Under <strong>Ask permission</strong>, change the dropdown from <strong>Important changes</strong> to <strong>Never</strong> — this allows AskToAct to update Bullhorn records without a confirmation prompt each time. You may notice a <strong>DEV</strong> badge next to the app name — this is normal for custom connectors and does not affect how the app works",
